                  ...
                  <div class="card shadow mb-4 h-100">
                    <div class="card-header py-3">
                      <div class="col-sm-11 float-left">
                        ...
                        <button type="button" class="btn btn-primary btn float-right ml-1" id="submitModify">
                          작성완료 
                        </button>
                    </div>
                   ...
                   <div class="file_list">
              		  ...
              		  <c:forEach var="FileList" items="${fileList}">            		  
                         ...
                         <input type="text"  name="fileinput" value="${FileList.ORG_FILE_NAME}"  readonly />
                          <input type="hidden" id="UUID" name="UUID" value="${FileList.FILE_NAME}">	
 						 <input type="file" name="fileinput" id="files" onchange="selectFile(this);" data-uuid="${FileList.FILE_NAME}" multiple>
 							
                        </div>
                    <button type="button" onclick="removeFile(this);" class="btns del_btn" data-uuid="${FileList.FILE_NAME}"><span>삭제</span></button>
...
$('#submitModify').on('click', function() {
	   ...
	   $('input[type="file"][name="fileinput"]').each(function() {
